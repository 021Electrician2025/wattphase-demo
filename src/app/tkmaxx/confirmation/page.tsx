...
import { generateJobTicketId, tkmaxxLocation } from "@/lib/mock-data";
...
export default function TKMaxxConfirmationPage() {
  ...
  const [jobTicket] = useState<JobTicket>({
    ...
    description:
      "Critical power loss detected on Phase 3 affecting retail operations at TKMaxx Douglas Village Shopping Centre.",
    location: {
      lat: tkmaxxLocation.lat,
      lng: tkmaxxLocation.lng,
      address: tkmaxxLocation.address,
    },
  });
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-bold text-green-800">
                  Electrician Successfully Dispatched to TKMaxx Douglas!
                </h2>
                <p className="text-sm sm:text-base text-green-700">
                  Your emergency request has been processed and an electrician
                  is on the way to restore power systems.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            {currentStatus === "completed" && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4">
                ...
                <p className="text-xs sm:text-sm text-green-700">
                  The electrical issue has been resolved at TKMaxx Douglas. Power has been
                  restored to all phases and retail operations can resume normally. A detailed report will be sent to your
