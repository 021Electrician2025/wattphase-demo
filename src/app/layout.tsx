...
import "./globals.css";
import { PowerProvider } from "@/contexts/power-context";
...
export const metadata: Metadata = {
  title: "Wattphase - Smart Power Monitoring",
  description:
    "Real-time power monitoring and emergency response system for critical infrastructure",
  icons: {
    icon: [{ url: "/favicon-196.png", sizes: "512x512", type: "image/png" }],
