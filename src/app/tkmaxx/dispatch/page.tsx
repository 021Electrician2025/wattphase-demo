...
import { tkmaxxElectricians, tkmaxxLocation } from "@/lib/mock-data";
...
export default function TKMaxxDispatchPage() {
  ...
  const handleAssign = async (electrician: Electrician) => {
    ...
    setTimeout(() => {
      ...
      router.push("/tkmaxx/confirmation");
    }, 2000);
  };

  const availableElectricians = tkmaxxElectricians
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Dispatching {state.selectedElectrician?.name} to TKMaxx Douglas...
            </CardDescription>
          </CardHeader>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                <p className="text-red-700 text-sm sm:text-base">
                  {tkmaxxLocation.address}
                </p>
                <p className="text-xs sm:text-sm text-red-600 mt-2">
                  Issue: Power loss detected on Phase 3 - Critical
              ...
              <div className="bg-red-100 p-3 sm:p-4 rounded-lg">
                ...
                <p className="text-xs sm:text-sm text-red-700">
                  Store operations disrupted affecting lighting, POS systems, and security.
                  Immediate response required to resume business operations.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Electrician Locations - Douglas Area</CardTitle>
            <CardDescription>
              Real-time positions of available electricians and TKMaxx location
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ElectricianMap
              electricians={tkmaxxElectricians}
              emergencyLocation={tkmaxxLocation}
