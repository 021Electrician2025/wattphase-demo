...
export default function TKMaxxDashboard() {
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
              TKMaxx Douglas - Power Monitoring
            </h1>
            <p className="text-gray-600 text-sm sm:text-base">
              Douglas Village Shopping Centre, Douglas, Cork, T12 PPK8
            </p>
          </div>
          ...
          <AlertDialogContent className="sm:max-w-md">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-base">
                ⚠️ Power Drop Detected at TKMaxx Douglas – Would you like to dispatch an electrician?
              </AlertDialogDescription>
            </AlertDialogHeader>
