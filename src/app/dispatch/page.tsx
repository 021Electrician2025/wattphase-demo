...
import { mockElectricians, emergencyLocation } from "@/lib/mock-data";
...
export default function DispatchPage() {
  ...
  const availableElectricians = mockElectricians
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Dispatching {state.selectedElectrician?.name} to your location...
            </CardDescription>
          </CardHeader>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Electrician Locations - Cork, Ireland</CardTitle>
            <CardDescription>
              Real-time positions of available electricians and emergency
              location
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ElectricianMap
              electricians={mockElectricians}
